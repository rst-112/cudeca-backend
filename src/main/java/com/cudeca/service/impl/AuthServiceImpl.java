...
public class AuthServiceImpl implements AuthService {
    ...
    private void migrarDatosDeInvitado(Usuario usuario) {
        ...
        if (invitadoOpt.isPresent()) {
            ...
            log.info("Invitado encontrado con email {}. Iniciando migración de datos...", usuario.getEmail());
            ...
            if (comprasDelInvitado != null && !comprasDelInvitado.isEmpty()) {
                ...
                log.info("Se han migrado {} compras del invitado al usuario ID: {}", comprasDelInvitado.size(), usuario.getId());
            }
